  ...
  text_src_peoplePickerWidget_peoplePickerhtml = 
      '<div>' +
           '<div class="pt-pickSPUser">' +
              '<div class="pt-pickSPUser-selected"> None Selected! </div>' +
              '<div style="clear:both"></div>' +
              '<div class="pt-pickSPUser-input" title="Type user name above to view search results.">'+
                '<input name="pickSPUserInputField" type="text" class="form-control closeicon"/>' +
              '</div>'+
           '</div>' +
              ...
              '<div class="pt-pickSPUser-person-cntr ui-state-default ui-corner-all">' +
                 ...
                 '<div class="pt-pickSPUser-person-actions">' +
                    '<div class="tt-record-item-action-links">' +
                       '<a class="tt-delete-icon" href="javascript:"><span class="k-icon k-i-close"></span></a> ' +
                       '<div style="clear:both"></div>' +
                    '</div>' +
                    '<div style="clear:both"></div>' +
                 '</div>' +
